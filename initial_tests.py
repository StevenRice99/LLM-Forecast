...
if __name__ == '__main__':
    # Polynomial trials.
    auto("Data/COVID Ontario.csv", 1, 8, 0, 0, 100, 0, [1, 2, 3, 4, 5], 5, None, None, False, output="POLYNOMIAL")
    evaluate("Results/POLYNOMIAL", ["Available", "Needed", "Arrived"], True, 10, 5, False)
    # ARIMA trials.
    for p in [0, 1, 2]:
        for d in [0, 1, 2]:
            for q in [0, 1, 2]:
                auto("Data/COVID Ontario.csv", 1, 8, 0, 0, 100, 0, 0, 5, {"p": p, "d": d, "q": q}, None, False,
                     output="ARIMA")
